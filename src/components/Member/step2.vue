...
<el-form-item label="学校" style="margin-top:35px;margin-left:-48px;"><br/>
     <el-input v-model="form.eduSchool1" style="width:190px;margin-left:-42px; "></el-input>
  </el-form-item>
<el-form-item label="专业" style="margin-left:-52px;margin-top:35px" ><br/>
     <el-input v-model="form.eduMajor1" style="width:150px;margin-left:-39px;"></el-input>
  </el-form-item>

   <el-form-item label="学历" style="margin-left:-52px;margin-top:35px"><br/>
    <el-select v-model="form.eduCation1" placeholder="请选择学历"  style="width: 90%;margin-left:-39px;">
...
<el-form-item label="" style="margin-top:-5px;margin-left:-20px;" >
     <el-input v-model="form.eduSchool2" style="width:190px;margin-left:10px; "></el-input>
  </el-form-item>
<el-form-item label="" style="margin-left:-30px;margin-top:-5px" >
     <el-input v-model="form.eduMajor2" style="width:150px;margin-left:18px;"></el-input>
  </el-form-item>

   <el-form-item label="" style="margin-left:-15px;margin-top:-5px">
    <el-select v-model="form.eduCation2" placeholder="请选择学历"  style="width: 75%;margin-left:4px;">
      <el-option label="初中/高中/中职" value="初中/高中/中职"></el-option>
      <el-option label="专科" value="专科"></el-option>
      <el-option label="本科" value="本科"></el-option>
      <el-option label="硕士" value="硕士"></el-option>
...
<el-form-item label="" style="margin-top:-5px;margin-left:-20px;" >
     <el-input v-model="form.eduSchool3" style="width:190px;margin-left:10px; "></el-input>
  </el-form-item>
<el-form-item label="" style="margin-left:-30px;margin-top:-5px" >
     <el-input v-model="form.eduMajor3" style="width:150px;margin-left:18px;"></el-input>
  </el-form-item>

   <el-form-item label="" style="margin-left:-15px;margin-top:-5px">
    <el-select v-model="form.eduCation3" placeholder="请选择学历"  style="width: 75%;margin-left:4px;">
      <el-option label="初中/高中/中职" value="初中/高中/中职"></el-option>
      <el-option label="专科" value="专科"></el-option>
      <el-option label="本科" value="本科"></el-option>
      <el-option label="硕士" value="硕士"></el-option>
   ...
   <el-form-item label="工作时间" style="margin-top:5px;margin-left:58px;"><br/>
    ...
    <el-form-item label="工作单位" style="margin-top:5px;margin-left:-22px;" ><br/>
      <el-input v-model="form.jobUnit1" style="width:190px;margin-left:-68px; "></el-input>
    </el-form-item>
    <el-form-item label="科室" style="margin-left:-52px;margin-top:5px" ><br/>
     <el-input v-model="form.department1" style="width:150px;margin-left:-39px;"></el-input>
    </el-form-item>
   ...
   <el-form-item label="" style="margin-top:-45px;margin-left:138px;"><br/>
    ...
    <el-form-item label="" style="margin-top:-45px;" ><br/>
      <el-input v-model="form.jobUnit2" style="width:190px;margin-left:-10px; "></el-input>
    </el-form-item>
    <el-form-item label="" style="margin-top:-45px" ><br/>
     <el-input v-model="form.department2" style="width:150px;margin-left:-10px;"></el-input>
    </el-form-item>
    ...
    <el-form-item label="" style="margin-top:-45px;" ><br/>
      <el-input v-model="form.jobUnit3" style="width:190px;margin-left:-10px; "></el-input>
    </el-form-item>
    <el-form-item label="" style="margin-top:-45px" ><br/>
     <el-input v-model="form.department3" style="width:150px;margin-left:-10px;"></el-input>
    </el-form-item>
  ...
  <el-form-item label="主要成就" prop="mainResult" style="margin-left:58px;"><br/><span>dfefe</span>
    <el-input type="textarea" v-model="form.mainResult" style="margin-left:-107px;width:600px;"></el-input>
  </el-form-item>
  <el-form-item>
    <el-button type="primary" @click="submitForm('form')" style="margin-top:0px;margin-left:70px;">下一步</el-button>
...
<script>
  export default {
    ...
    methods:{
      submitForm(form) {
        this.form.eduTime1 = this.time1;
        this.form.eduTime2 = this.time2;
        this.form.eduTime3 = this.time3;
        this.form.jobTime1 = this.time4;
        this.form.jobTime2 = this.time5;
        this.form.jobTime3 = this.time6;
        this.$refs[form].validate((valid) => {
          if (valid) {
            this.http
            .post('http://127.0.0.1:8888/member/FirInfo', this.form)
            .then(res => {
                if (+res.err.code === 200) {
                    //alert("200");
                    //this.$emit('step',"1");
